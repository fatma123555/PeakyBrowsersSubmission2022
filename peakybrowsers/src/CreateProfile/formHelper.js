...
class NameFormHelper extends React.Component {
  constructor(props) {
    super(props);
            ...
            <div className="input-container">
              ...
              {(!this.state.email ||
                ...
                <button type="submit" disabled>
                  <BiLogIn className="submit-button-disabled" onclick="handle" />
                </button>
              )}
              <p>
                Hava an account already?{" "}
                <Link to="/loginformhelper"> Click here to login</Link>
              </p>
            </div>
          </div>
        </form>
